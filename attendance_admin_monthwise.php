...
<body>
<form name="myform" action="attendance_admin_monthwise.php" method="get">
    ...
    <div style="max-width: 71rem;" class="container">
        <header class="header clearfix">
            ...
            <h3 class="text-muted">Admin Attendance Manager</h3>
        </header>
        <!--
        ...
        <input type="submit" class="btn btn-default" style="background-color:#673ab7;color:white;" name="down" value="Download">
...
if ($_GET) {
        ...
        if(isset($_GET['down'])){
            header("Location:csvdownAdmin.php?month=".$mon."+".$yr."&mm=Submit");
        }
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            if ($i == 1) {
                echo "<tr><td> $row[Username]</td><td> $row[fname] $row[lname] </td>";
                $name = $row['fname'];
                $workingmins = 0;
                $daysPresent = 0;
                $mins = 0;
                ...
                echo "</tr><tr><td>$row[Username]</td><td> $row[fname] $row[lname] </td>";
                $name = $row['fname'];
